...
The exact memory numbers depend on the interpreter, platform, and object representation, but the important point is that a generator usually uses far less memory up front than a fully materialized list.
