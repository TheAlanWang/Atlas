  ...
  return (
    <>
      ...
      >
        <span
          aria-hidden="true"
          className="absolute -inset-2.5 opacity-85"
          style={{
            background:
              "conic-gradient(from 0deg, #ff4e6e, #ff9b2e, #ffe135, #4fffb0, #4dc8ff, #a259ff, #ff4e6e)",
            animation:
              "atlas-spin 5s linear infinite, atlas-blob 5s ease-in-out infinite",
            filter: "blur(14px)",
          }}
        />
        <span
          ...
          style={{
            background:
              "conic-gradient(from 180deg, #a259ff, #4dc8ff, #4fffb0, #ffe135, #ff9b2e, #ff4e6e, #a259ff)",
            animation:
              "atlas-spin 3s linear infinite reverse, atlas-blob 4s ease-in-out infinite reverse",
            filter: "blur(6px)",
          }}
        />
        <span
          className="relative z-10 text-[22px] text-white"
