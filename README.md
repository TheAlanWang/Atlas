...
- Dark mode support
- AI chat assistant — ask questions about any knowledge article on the site
  - Powered by OpenAI `text-embedding-3-small` + Supabase pgvector
  - Streams responses via GPT-4o
  - Cites source knowledge articles
...
After adding or editing knowledge articles, re-run the embedding script to update the vector database:
...
- Skips unchanged knowledge articles (MD5 hash check)
- Re-embeds modified knowledge articles
- Inserts new knowledge articles
